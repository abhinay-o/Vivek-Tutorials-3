...
if (isset($_POST['upload'])) {
	...
	$q = "INSERT INTO video10 (name ,title,subject) VALUES ('$file_name', '$title' , '$subject')";
...
<html>
<head>
	<title>Upload Class 10th Lectures </title>
...
<br>		<br>	
				...
				<form class="form" action="#" method="post" enctype="multipart/form-data">
					<br>
				<h2>Upload Class 10th Lectures </h2>
				<br>
...
<a href="batch10.php"><input type="submit " value=" Uploaded Videos " class="seeupload"  > </input></a>
<br><br>
