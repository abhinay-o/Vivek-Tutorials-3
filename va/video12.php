...
if (isset($_POST['upload'])) {
	...
	$q = "INSERT INTO video12 (name ,title,subject) VALUES ('$file_name', '$title' , '$subject')";
...
<html>
<head>
	<title>Upload Class 12th Lectures </title>
...
<br>		<br>	
				...
				<form action="#" method="post" enctype="multipart/form-data">
					<br>
				<h2>Upload Class 12th Lectures </h2>
				<br>
...
<a href="batch12.php"><input type="submit " value=" Uploaded Videos " class="seeupload"  > </input></a>
<br><br>
