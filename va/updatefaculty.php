...
if(isset($_GET['ID'])) {
    $ID = $_GET['ID'];
    $query = "SELECT name, email, username FROM teacher WHERE ID = '$ID'";
...
if(isset($_POST['submit'])) {
    ...
    $query = "UPDATE teacher SET name=?, email=?, username=? WHERE ID=?";
    ...
    if($result) {
        ...
        window.location.href='viewfaculty.php';</script>
        ";
